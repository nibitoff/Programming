 ...
 * @version 1.0
 * Method for managing user`s command
 */

public class  CommandManager {
    /** Collection manager for taking user`s commands */
     ...
     * @param consoleManager - ConsoleManager class object which will realise user`s commands
     */
