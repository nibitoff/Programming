...
public class ConsoleManager {
    ...
    public LinkedList<Organization> organizations = new LinkedList<>();
    /** HashMap collection for making an instruction */
    private final HashMap<String, String> consoleInfo;
    public ConsoleManager(Sender sender) throws IOException {
        String filePath = "C:\\Users\\spide\\OneDrive\\Desktop\\STUDIES\\PROGRAMMING\\Lab6\\hi.csv";
        checkFile(filePath);
        Integer fileId = null;
    ...
    /** add {element}, adding a new element to collection using all maker-methods */
        public void add (Organization org) {
            ...
            /*Organization newOrg = new Organization(makerID(),organization.getName() , organization.getAnnualTurnover(), getDate(),
                    organization.getFullName(), organization.getType(),organization.getOfficialAddress(), organization.getCoordinates());
        ...
        public void update_id (Organization org) {
            try {
